...
import com.example.android.architecture.blueprints.todoapp.statistics.ViewModel.Numbers;
...
public class FeaturedPresenterTest {
    ...
    @Mock
    private View<ViewModel> mStatisticsView;
    ...
    public void loadEmptyTasksFromRepository_CallViewToDisplay() {
        ...
        assertThat(model.getAllValues().stream().map(ViewModel::progressIndicator).collect(toList()), contains(false, true, false));
