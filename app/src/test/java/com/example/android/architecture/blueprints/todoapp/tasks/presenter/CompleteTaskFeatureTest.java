...
public class CompleteTaskFeatureTest {
    ...
    public void emitsStartReducer_beforeRepositorySucceeds() {
        ...
        observer.assertValue(state -> state.completeTaskInProgress() && !state.showTaskMarkedComplete());
    }
    ...
    public void emitsStartAndSuccessReducers_whenRepositorySucceeds() {
        ...
        observer.assertValueAt(1, state -> !state.completeTaskInProgress() && state.showTaskMarkedComplete());
    }
