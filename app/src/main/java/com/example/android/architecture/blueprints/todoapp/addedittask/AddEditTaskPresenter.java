 ...
 */
public final class AddEditTaskPresenter implements Presenter {
     ...
     */
    @Inject
    public AddEditTaskPresenter(@Nullable String taskId, @NonNull TasksRepository tasksRepository, Lazy<Boolean> shouldLoadDataFromRepo) {
        this.taskId = taskId;
    ...
    public void populateTask() {
        ...
        tasksRepository.getTask(taskId, new TasksDataSource.GetTaskCallback() {
            ...
            public void onTaskLoaded(Task task) {
                AddEditTaskPresenter.this.onTaskLoaded(task);
            }

            @Override
            public void onDataNotAvailable() {
                AddEditTaskPresenter.this.onDataNotAvailable();
            }
        });
    }
